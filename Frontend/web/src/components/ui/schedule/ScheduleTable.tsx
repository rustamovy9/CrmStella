    ...
    return (
      ...
      >
        ...
        <div style={{ display: "flex", gap: "6px" }}>
          <button
            style={btnBase}
            onClick={() => onNavigate(slot.groupId)}
            title="Перейти"
          >
          ...
          <button
            style={{ ...btnBase, background: "#FEE2E2" }}
            onClick={() => onDelete(slot.id, slot.groupName || "")}
            title="Удалить"
            >
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", gap: "4px", marginTop: "auto" }}>
        ...
        <button
          style={{ ...btnBase, width: 26, height: 26, background: "#FEE2E2" }}
          onClick={() => onDelete(slot.id, slot.groupName || "")}
        >
          ...
          >
            ...
            <span
              style={{
                ...
                borderRadius: "20px",
                background:
                  visibleDays[0].key === todayKey ? "#EEF2FF" : "#F1F5F9",
