...
import StudentGroupsPage from "./pages/student/education/GroupsPage";
import StudentGroupDetailPage from "./pages/student/education/GroupDetailPage";
import StudentJournalPage from "./pages/student/journal/JournalPage";

import MentorDashboard from "./pages/mentor/dashboard/MentorDashboard";
import MentorGroupsPage from "./pages/mentor/education/GroupsPage";
import MentorGroupDetailPage from "./pages/mentor/education/GroupDetailPage";
import MentorJournalPage from "./pages/mentor/journal/JournalPage";
// import MentorSchedulePage from "./pages/mentor/education/ShedulePage";
              ...
              <ProtectedRoute allowedRoles={["Mentor"]}>
                <MainLayout role="Mentor">
                  <Routes>
                    ...
                    <Route
                      path="groups/:id"
                      element={<MentorGroupDetailPage />}
                    />
                    {/* Добавили роут сюда, чтобы mentor тоже мог зайти в журнал */}
                    <Route
                      path="groups/:groupId/journal"
                      element={<MentorJournalPage />}
                    />
              ...
              <ProtectedRoute allowedRoles={["Student"]}>
                <MainLayout role="Student">
                  <Routes>
                    ...
                    {/* Добавили роут сюда, чтобы студен тоже мог зайти в журнал */}
                    <Route
                      path="groups/:groupId/journal"
