...
public interface IHomeworkSubmissionRepository
{
    ...
    Task<List<HomeworkSubmission>> GetByHomeworkIdAsync(
        int homeworkId,
        CancellationToken cancellationToken = default);

    Task<List<HomeworkSubmission>> GetByStudentIdAsync(
        int studentId,
        CancellationToken cancellationToken = default);

    Task<List<HomeworkSubmission>> GetByHomeworkAsync(
        int homeworkId,
        CancellationToken cancellationToken = default);

    Task<HomeworkSubmission?> GetByHomeworkAndStudentAsync(
        int homeworkId,
        int studentId,
        CancellationToken cancellationToken = default);
