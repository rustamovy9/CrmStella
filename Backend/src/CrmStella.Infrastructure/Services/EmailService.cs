...
public class EmailService(IOptions<EmailSettings> settings) : IEmailService
{
    ...
    {
        var subject = "Your verification code — CrmStella";
        var body = $"""
    ...
    {
        var subject = "Password reset code — CrmStella";
        var body = $"""
    ...
    {
        var subject = "Welcome to CrmStella";
        var body = $"""
                    <p style="margin: 0 0 6px; font-size: 13px; color: #888; text-transform: uppercase; letter-spacing: 1px;">Account Created</p>
                    <p style="margin: 0 0 24px; font-size: 15px; color: #444;">Hello, <strong style="color: #111;">{fullName}</strong>. Your CrmStella account is ready.</p>
                                        ...
                                        <table width="100%" cellpadding="0" cellspacing="0" style="max-width: 520px;">
                                            ...
                                            <tr>
                                                <td style="padding: 0 0 20px;">
                                                    <table width="100%" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            <td>
                                                                <span style="font-size: 15px; font-weight: 700; color: #111; letter-spacing: -0.3px;">CrmStella</span>
                                                            </td>
                                                            <td align="right">
                                            ...
                                            <tr>
                                                <td style="padding: 20px 0 0; text-align: center;">
                                                    <span style="font-size: 12px; color: #bbb;">© 2026 CrmStella · This is an automated message, please do not reply.</span>
                                                </td>
                                            </tr>
