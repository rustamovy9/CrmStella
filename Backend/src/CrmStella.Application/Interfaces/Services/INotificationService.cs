...
using CrmStella.Application.DTOs.Notification.Request;
using CrmStella.Application.DTOs.Notification.Response;
...
public interface INotificationService
{
    ...
    Task<Result<List<NotificationResponse>>>
        GetByUserIdAsync(int userId, CancellationToken cancellationToken = default);

    Task<Result<List<NotificationResponse>>> GetUnreadByUserIdAsync(int userId,
    ...
    Task<Result<NotificationResponse>> UpdateAsync(UpdateNotificationRequest request,
        CancellationToken cancellationToken = default);
